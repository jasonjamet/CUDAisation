...
if (j < S + D) {
	...
	L'application est capable de paralléliser des fonctions contenant des boucles simples, avec plus de temps il serait tout à fait possible de traiter un très grand panel de fonctions, même complexe.\\
	Finalement, cette expérience nous a fait monter en compétence sur les analyseurs flex/bison, les langages c++/cuda et nous a donné une plus grande visibilité sur la difficulté à transformer un code itératif en code parallélisé.
