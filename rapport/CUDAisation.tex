...
__global__ void kernel(float *x, float *y, float *z, int size) { 
	...
	~~\\
	\indent
	Afin de repérer la boucle à paralléliser, nous nous sommes basé sur la variable contenue dans le paramètre du \verb|pragma|, à laquelle nous l'avons comparé à celle contenue dans la boucle \verb|for|.
	...
	Parler des différentes approches de traitement (pre abre post arbre)
